                ...
                <div className="login-page-container">
                    ...
                    <form className="login-form">
                        <div className="input-container">
                            <input type="text" autoComplete="email" placeholder="Email or mobile number" />
